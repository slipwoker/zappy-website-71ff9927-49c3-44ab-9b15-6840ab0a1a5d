    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Santa Casa Resort uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '71ff9927-49c3-44ab-9b15-6840ab0a1a5d',
                    name: data.name || '',
                    email: data.email || '',
